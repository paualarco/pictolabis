    ...
    <>
      ...
      <Container maxWidth={themeStretch ? false : 'md'} sx={{ marginTop: '60px' }}>
        <Typography gutterBottom>
          Hey there! Thanks for checking out this site, my name is Pau Alarcón, I am a Software
          Engineer and have become a hobbiest of creating digital art through AI
        </Typography>
        <Typography gutterBottom>
        ...
        <Typography gutterBottom>
          Get in touch with me if you would like to share your feedback!
        </Typography>
