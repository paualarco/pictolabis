  ...
  return (
    <>
      ...
      <Container maxWidth={themeStretch ? false : 'md'} sx={{ marginTop: '20px' }}>
        ...
        <Typography gutterBottom>
          I am an image prompt generator, designed to provide you with unique and inspiring prompts
          that will spark your creativity and help you write original descriptions for images
          generated by AI.💡🤖
        </Typography>
